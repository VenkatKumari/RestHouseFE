...
public class Main2Activity extends AppCompatActivity implements
    ...
    String phoneNum,eid,ename,email,designation;
    ...
    private void startPhoneNumberVerification(String phoneNumber) {
        ...
        MobQuery mobQuery = MobQuery.builder().id(phoneNumber).build();
        apolloClient.query(mobQuery)
                .enqueue(new ApolloCall.Callback<MobQuery.Data>() {
                    ...
                    public void onResponse(@Nonnull Response<MobQuery.Data> response) {
                        phoneNum = response.data().employee().get(0).empmobile;
                        eid = response.data().employee().get(0).empid;
                        ename = response.data().employee().get(0).empname;
                        email = response.data().employee().get(0).empemailid;
                        designation = response.data().employee().get(0).designation;
                    }
    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        ...
        if (user == null) {
            ...
            */
            ...
            Intent intent = new Intent(this, RequestSumbit.class);
            intent.putExtra("Empid",eid);
            intent.putExtra("Empna",ename);
            intent.putExtra("Empmail",email );
            intent.putExtra("Empmob",phoneNum);
            intent.putExtra("Empdes",designation);
